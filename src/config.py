...
SINGLE_CLASS_PRICE_BREATH_BYN = parse_int(os.getenv("SINGLE_CLASS_PRICE_BREATH_BYN", ""))
SINGLE_CLASS_PRICE_BREATH_EUR = parse_int(os.getenv("SINGLE_CLASS_PRICE_BREATH_EUR", ""))
