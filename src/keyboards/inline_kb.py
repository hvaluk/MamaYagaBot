...
def course_options_kb():
    kb = types.InlineKeyboardMarkup()
    kb.add(types.InlineKeyboardButton('Оплатить и начать заниматься', callback_data='course_pay'))
    kb.add(types.InlineKeyboardButton('Узнать подробнее', callback_data='course_more'))
    return kb
 
def info_course_options_kb():
    kb = types.InlineKeyboardMarkup()
    kb.add(types.InlineKeyboardButton('Оплатить и начать заниматься', callback_data='course_pay'))
    kb.add(types.InlineKeyboardButton('Пройти пробный урок',callback_data='menu_trial'))
    kb.add(types.InlineKeyboardButton('Назад', callback_data='fmt_back'))
...
def individual_session_kb():
    kb = types.InlineKeyboardMarkup()
    kb.add(types.InlineKeyboardButton('Начать заниматься', callback_data='fmt_individual'))
    kb.add(types.InlineKeyboardButton('Узнать подробнее', callback_data='course_more'))
    kb.add(types.InlineKeyboardButton('Назад', callback_data='fmt_back'))
    return kb
...
def more_info_kb():
    ...
    kb.add(types.InlineKeyboardButton('Узнать о предоплате, чтобы зафиксировать цену', callback_data='prepayment_info'))
    kb.add(types.InlineKeyboardButton('Пройти пробный урок', callback_data='menu_trial'))
    kb.add(types.InlineKeyboardButton('Назад', callback_data='fmt_back'))
    return kb
...
def prepayment_kb():
    kb = types.InlineKeyboardMarkup()
    kb.add(types.InlineKeyboardButton('Внести предоплату, чтобы зафиксировать цену ', url=COURSE_PAY_LINK))
    kb.add(types.InlineKeyboardButton('Пройти пробный урок', callback_data='menu_trial'))
    kb.add(types.InlineKeyboardButton('Назад', callback_data='fmt_back'))
    return kb